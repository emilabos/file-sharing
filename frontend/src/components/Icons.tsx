...
export const PowerPointIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    <rect x="3" y="3" width="18" height="18" rx="2" fill="currentColor" />
    <path d="M8 8h8l-4 4-4 4V8z" fill="white" />
  </svg>
);
...
export const DefaultFileIcon = ({ className }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
export const LoadingSpinner = ({ className }: { className?: string }) => (
  <div
    className={`border-2 border-gray-200 border-t-primary-blue rounded-full animate-spin ${className}`}
  />
);
